...
| [![Publish](https://img.shields.io/badge/Conference-ICML_2025-blue)]() <br> RocketKV: Accelerating Long-Context LLM Inference via Two-Stage KV Cache Compression [[Link](https://openreview.net/pdf?id=RyOpooIxDF)] <br> *Payman Behnam, Yaosheng Fu, Ritchie Zhao, Po-An Tsai, Zhiding Yu, Alexey Tumanov*| Token-level attention compute scheduling |[![stars](https://img.shields.io/github/stars/NVlabs/RocketKV?style=social)](https://github.com/NVlabs/RocketKV) <br> ![](https://img.shields.io/github/last-commit/NVlabs/RocketKV?color=green) <br> [RocketKV](https://github.com/NVlabs/RocketKV)|
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-FPGA_2026-cyan)]() <br> CXL-SpecKV: A Disaggregated FPGA Speculative KV-Cache for Datacenter LLM Serving [[Link](https://dl.acm.org/doi/epdf/10.1145/3748173.3779188)] <br> *Dong Liu, Yanxuan Yu* | GPU compute ↔ GPU KV prefetch (CXL memory→L2); Also belongs to memory hierarchy KV orchestration (spatial) |[![stars](https://img.shields.io/github/stars/FastLM/CXL-SpecKV?style=social)](https://github.com/FastLM/CXL-SpecKV) <br> ![](https://img.shields.io/github/last-commit/FastLM/CXL-SpecKV?color=green) <br> [CXL-SpecKV](https://github.com/FastLM/CXL-SpecKV) |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-FAST_2025-cyan)]() ![Award](https://img.shields.io/badge/Best%20Paper%20Award-gold?logo=star&logoColor=white) <br> Mooncake: Trading More Storage for Less Computation — A KVCache-centric Architecture for Serving LLM Chatbot [[Link](https://www.usenix.org/system/files/fast25-qin.pdf)] <br> *Ruoyu Qin, Zheming Li, Weiran He, Jialei Cui, Feng Ren, Mingxing Zhang, Yongwei Wu, Weimin Zheng, Xinran Xu* | PD disaggregation; Also belongs to KV-centric scheduling | [![stars](https://img.shields.io/github/stars/kvcache-ai/Mooncake?style=social)](https://github.com/kvcache-ai/Mooncake) <br> ![](https://img.shields.io/github/last-commit/kvcache-ai/Mooncake?color=green) <br> [Mooncake](https://github.com/kvcache-ai/Mooncake) 🌟 |
...
| [![Publish](https://img.shields.io/badge/Conference-ICML_2024-blue)]() <br> MuxServe: Flexible Spatial-Temporal Multiplexing for Multiple LLM Serving [[Link](https://openreview.net/pdf?id=R0SoZvqXyQ)] <br> *Jiangfei Duan, Runyu Lu, Haojie Duanmu, Xiuhong Li, Xingcheng Zhang, Dahua Lin, Ion Stoica, Hao Zhang* | Colocating PD jobs of multiple LLMs within each GPU via SM partitioning; Also belongs to KV-centric scheduling |[![stars](https://img.shields.io/github/stars/hao-ai-lab/MuxServe?style=social)](https://github.com/hao-ai-lab/MuxServe) <br> ![](https://img.shields.io/github/last-commit/hao-ai-lab/MuxServe?color=green) <br> [MuxServe](https://github.com/hao-ai-lab/MuxServe)  |
...
| [![Publish](https://img.shields.io/badge/Conference-ASPLOS_2025-cyan)]() <br> PAPI: Exploiting Dynamic Parallelism in Large Language Model Decoding with a Processing-In-Memory-Enabled Computing System [[Link](https://dl.acm.org/doi/pdf/10.1145/3676641.3716009)] <br> *Yintao He, Haiyu Mao, Christina Giannoula, Mohammad Sadrosadati, Juan Gómez-Luna, Huawei Li, Xiaowei Li, Ying Wang, Onur Mutlu* | PIM-based offloading | |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2026-blue)]() <br> AtlasKV: Augmenting LLMs with Billion-Scale Knowledge Graphs in 20GB VRAM [[Link](https://openreview.net/forum?id=6i1jVAYbHs)] <br> *Haoyu Huang, Hong Ting Tsang, Jiaxin Bai, Xi Peng, Gong Zhang, Yangqiu Song*| Importance-aware methods | [![stars](https://img.shields.io/github/stars/HKUST-KnowComp/AtlasKV?style=social)](https://github.com/FastLM/CXL-SpecKV) <br> ![](https://img.shields.io/github/last-commit/HKUST-KnowComp/AtlasKV?color=green) <br> [AtlasKV](https://github.com/HKUST-KnowComp/AtlasKV) |
| [![Publish](https://img.shields.io/badge/Conference-SIGMOD_2026-blue)]() <br> Beluga: A CXL-Based Memory Architecture for Scalable and Efficient LLM KVCache Management [[Link](https://arxiv.org/pdf/2511.20172)] <br> *Xinjun Yang, Qingda Hu, Junru Li, Feifei Li, Yicong Zhu, Yuqi Zhou, Qiuru Lin, Jian Dai, Yang Kong, Jiayu Zhang, Guoqiang Xu, Qiang Liu*| System cost-driven decision | |
| [![Publish](https://img.shields.io/badge/Conference-FPGA_2026-cyan)]() <br> CXL-SpecKV: A Disaggregated FPGA Speculative KV-Cache for Datacenter LLM Serving [[Link](https://dl.acm.org/doi/epdf/10.1145/3748173.3779188)] <br> *Dong Liu, Yanxuan Yu* | System cost-driven decision; Also belongs to pipelining & overlapping (temporal) |[![stars](https://img.shields.io/github/stars/FastLM/CXL-SpecKV?style=social)](https://github.com/FastLM/CXL-SpecKV) <br> ![](https://img.shields.io/github/last-commit/FastLM/CXL-SpecKV?color=green) <br> [CXL-SpecKV](https://github.com/FastLM/CXL-SpecKV) |
| TraCT: Disaggregated LLM Serving with CXL Shared Memory KV Cache at Rack-Scale [[Link](https://arxiv.org/pdf/2512.18194)] <br> *Dongha Yoon, Younghoon Min, Hoshik Kim, Sam H. Noh, Jongryool Kim*| System cost-driven decision; Also belongs to compute device KV orchestration |  |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2025-blue)]() <br> KVFlow: Efficient Prefix Caching for Accelerating LLM-Based Multi-Agent Workflows [[Link](https://openreview.net/pdf?id=5Iw1nDtYmT)] <br> *Zaifeng Pan, Ajjkumar Patel, Zhengding Hu, Yipeng Shen, Yue Guan, Wan-Lu Li, Lianhui Qin, Yida Wang, Yufei Ding*| Importance-aware methods | |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2025-blue)]() <br> RetrievalAttention: Accelerating Long-Context LLM Inference via Vector Retrieval [[Link](https://openreview.net/pdf?id=8z3cOVER4z)] <br> *Di Liu, Meng Chen, Baotong Lu, Huiqiang Jiang, Zhenhua Han, Qianxi Zhang, Qi Chen, Chengruidong Zhang, Bailu Ding, Kai Zhang, Chen Chen, Fan Yang, Yuqing Yang, Lili Qiu*| Importance-aware methods |[![stars](https://img.shields.io/github/stars/microsoft/RetrievalAttention?style=social)](https://github.com/microsoft/RetrievalAttention) <br> ![](https://img.shields.io/github/last-commit/microsoft/RetrievalAttention?color=green) <br> [RetrievalAttention](https://github.com/microsoft/RetrievalAttention) |
| LMCache: An Efficient KV Cache Layer for Enterprise-Scale LLM Inference [[Link](https://arxiv.org/pdf/2510.09665)] <br> *Yihua Cheng, Yuhan Liu, Jiayi Yao, Yuwei An, Xiaokun Chen, Shaoting Feng, Yuyang Huang, Samuel Shen, Kuntai Du, Junchen Jiang* | System cost-driven decision; Also belongs to compute device KV orchestration | [![stars](https://img.shields.io/github/stars/LMCache/LMCache?style=social)](https://github.com/LMCache/LMCache) <br> ![](https://img.shields.io/github/last-commit/LMCache/LMCache?color=green) <br> [LMCache](https://github.com/LMCache/LMCache) 🌟 |
...
| SlimInfer: Accelerating Long-Context LLM Inference via Dynamic Token Pruning [[Link](https://arxiv.org/abs/2508.06447)] <br> *Lingkun Long, Rubing Yang, Yushi Huang, Desheng Hui, Ao Zhou, Jianlei Yang*| Importance-aware methods | |
| [![Publish](https://img.shields.io/badge/Conference-ICML_2025-blue)]() <br> SpeCache: Speculative Key-Value Caching for Efficient Generation of LLMs [[Link](https://openreview.net/pdf?id=PQIrsaIQdn)] <br> *Shibo Jie, Yehui Tang, Kai Han, Zhi-Hong Deng, Jing Han* | Importance-aware methods | |
| [![Publish](https://img.shields.io/badge/Conference-ICML_2025-blue)]() ![Award](https://img.shields.io/badge/Spotlight-gold?logo=star&logoColor=white) <br> ShadowKV: KV Cache in Shadows for High-Throughput Long-Context LLM Inference [[Link](https://openreview.net/pdf?id=oa7MYAO6h6)] <br> *Hanshi Sun, Li-Wen Chang, Wenlei Bao, Size Zheng, Ningxin Zheng, Xin Liu, Harry Dong, Yuejie Chi, Beidi Chen* | Importance-aware methods; Also belongs to KV cache compression (structural) | [![stars](https://img.shields.io/github/stars/ByteDance-Seed/ShadowKV?style=social)](https://github.com/ByteDance-Seed/ShadowKV) <br> ![](https://img.shields.io/github/last-commit/ByteDance-Seed/ShadowKV?color=green) <br> [ShadowKV](https://github.com/ByteDance-Seed/ShadowKV) |
| [![Publish](https://img.shields.io/badge/Conference-SIGMOD_2025-blue)]() <br> PQCache: Product Quantization-based KVCache for Long Context LLM Inference [[Link](https://arxiv.org/pdf/2407.12820)] <br> *Hailin Zhang, Xiaodong Ji, Yilin Chen, Fangcheng Fu, Xupeng Miao, Xiaonan Nie, Weipeng Chen, Bin Cui*| Importance-aware methods |[![stars](https://img.shields.io/github/stars/HugoZHL/PQCache?style=social)](https://github.com/HugoZHL/PQCache) <br> ![](https://img.shields.io/github/last-commit/HugoZHL/PQCache?color=green) <br> [PQCache](https://github.com/HugoZHL/PQCache) |
| [![Publish](https://img.shields.io/badge/Conference-DAC_2025-cyan)]() <br> ClusterKV: Manipulating LLM KV Cache in Semantic Space for Recallable Compression [[Link](https://arxiv.org/pdf/2412.03213)] <br> *Guangda Liu, Chengwei Li, Jieru Zhao, Chenqi Zhang, Minyi Guo* | Importance-aware methods |[![stars](https://img.shields.io/github/stars/sjtu-zhao-lab/ClusterKV?style=social)](https://github.com/sjtu-zhao-lab/ClusterKV) <br> ![](https://img.shields.io/github/last-commit/sjtu-zhao-lab/ClusterKV?color=green) <br> [ClusterKV](https://github.com/sjtu-zhao-lab/ClusterKV) |
| [![Publish](https://img.shields.io/badge/Conference-EuroSys_2025-cyan)]() <br> Stateful Large Language Model Serving with Pensieve [[Link](https://arxiv.org/pdf/2312.05516)] <br> *Lingfan Yu, Jinkun Lin, Jinyang Li* | Importance-aware methods | |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2025-blue)]() <br> OmniKV: Dynamic Context Selection for Efficient Long-Context LLMs [[Link](https://openreview.net/forum?id=ulCAPXYXfa)] <br> *Jitai Hao, Yuke Zhu, Tian Wang, Jun Yu, Xin Xin, Bo Zheng, Zhaochun Ren, Sheng Guo* | Importance-aware methods; Also belongs KV-Centric Scheduling | ![](https://img.shields.io/github/stars/antgroup/OmniKV?style=social) <br> ![](https://img.shields.io/github/last-commit/antgroup/OmniKV?color=green) <br> [OmniKV](https://github.com/antgroup/OmniKV) |
| [![Publish](https://img.shields.io/badge/Conference-FAST_2025-cyan)]() <br> IMPRESS: An Importance-Informed Multi-Tier Prefix KV Storage System for Large Language Model Inference [[Link](https://www.usenix.org/system/files/fast25-chen-weijian-impress.pdf)] <br> *Weijian Chen, Shuibing He, Haoyang Qu, Ruidong Zhang, Siling Yang, Ping Chen, Yi Zheng, Baoxing Huai, Gang Chen* | Importance-aware methods | |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2024-blue)]() <br> ArkVale: Efficient Generative LLM Inference with Recallable Key-Value Eviction [[Link](https://www.proceedings.com/content/079/079017-3595open.pdf)] <br> *Renze Chen, Zhuofeng Wang, Beiquan Cao, Tong Wu, Size Zheng, Xiuhong Li, Xuechao Wei, Shengen Yan, Meng Li, Yun Liang* | Importance-aware methods |[![stars](https://img.shields.io/github/stars/pku-liang/ArkVale?style=social)](https://github.com/pku-liang/ArkVale) <br> ![](https://img.shields.io/github/last-commit/pku-liang/ArkVale?color=green) <br> [ArkVale](https://github.com/pku-liang/ArkVale) |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2024-blue)]() <br> InfLLM: Training-Free Long-Context Extrapolation for LLMs with an Efficient Context Memory [[Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/d842425e4bf79ba039352da0f658a906-Paper-Conference.pdf)] <br> *Chaojun Xiao, Pengle Zhang, Xu Han, Guangxuan Xiao, Yankai Lin, Zhengyan Zhang, Zhiyuan Liu, Maosong Sun* | Importance-aware methods |[![stars](https://img.shields.io/github/stars/thunlp/InfLLM?style=social)](https://github.com/thunlp/InfLLM) <br> ![](https://img.shields.io/github/last-commit/thunlp/InfLLM?color=green) <br> [InfLLM](https://github.com/thunlp/InfLLM) |
...
|Paper|Type|Code|
| -- | -- | -- |
| TraCT: Disaggregated LLM Serving with CXL Shared Memory KV Cache at Rack-Scale [[Link](https://arxiv.org/pdf/2512.18194)] <br> *Dongha Yoon, Younghoon Min, Hoshik Kim, Sam H. Noh, Jongryool Kim*| KV cache migration across GPUs via CXL; Also belongs to memory hierarchy KV orchestration |  |
| LMCache: An Efficient KV Cache Layer for Enterprise-Scale LLM Inference [[Link](https://arxiv.org/pdf/2510.09665)] <br> *Yihua Cheng, Yuhan Liu, Jiayi Yao, Yuwei An, Xiaokun Chen, Shaoting Feng, Yuyang Huang, Samuel Shen, Kuntai Du, Junchen Jiang* | KV cache placement & migration across GPUs; Also belongs to memory hierarchy KV orchestration | [![stars](https://img.shields.io/github/stars/LMCache/LMCache?style=social)](https://github.com/LMCache/LMCache) <br> ![](https://img.shields.io/github/last-commit/LMCache/LMCache?color=green) <br> [LMCache](https://github.com/LMCache/LMCache) 🌟 |
...
| Fast Distributed Inference Serving for Large Language Models [[Link](https://arxiv.org/pdf/2305.05920)] <br> *Bingyang Wu, Yinmin Zhong, Zili Zhang, Shengyu Liu, Fangyue Liu, Yuanhang Sun, Gang Huang, Xuanzhe Liu, Xin Jin*| KV cache placement & migration across GPUs; Also belongs to memory hierarchy KV orchestration |[![stars](https://img.shields.io/github/stars/LLMServe/FastServe?style=social)](https://github.com/LLMServe/FastServe) <br> ![](https://img.shields.io/github/last-commit/LLMServe/FastServe?color=green) <br> [FastServe](https://github.com/LLMServe/FastServe) |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2026-blue)]() <br> Channel-Aware Mixed-Precision Quantization for Efficient Long-Context Inference [[Link](https://openreview.net/pdf?id=yjr2jX41qO)] <br> *Chengxi Liao, Zeyi Wen* | Mixed-precision asymmetric KV quantization |![](https://img.shields.io/github/stars/cxiliao/ChanMix?style=social) <br> ![](https://img.shields.io/github/last-commit/cxiliao/ChanMix?color=green) <br> [ChanMix](https://github.com/cxiliao/ChanMix) |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-ICML_2025-blue)]() ![Award](https://img.shields.io/badge/Spotlight-gold?logo=star&logoColor=white) <br> ShadowKV: KV Cache in Shadows for High-Throughput Long-Context LLM Inference [[Link](https://openreview.net/pdf?id=oa7MYAO6h6)] <br> *Hanshi Sun, Li-Wen Chang, Wenlei Bao, Size Zheng, Ningxin Zheng, Xin Liu, Harry Dong, Yuejie Chi, Beidi Chen* | Target cached K tensors, layer-wise, fixed rank; Also belongs memory hierarchy KV orchestration (spatial) | ![](https://img.shields.io/github/stars/ByteDance-Seed/ShadowKV?style=social) <br> ![](https://img.shields.io/github/last-commit/ByteDance-Seed/ShadowKV?color=green) <br> [ShadowKV](https://github.com/ByteDance-Seed/ShadowKV) |
| ReCalKV: Low-Rank KV Cache Compression via Head Reordering and Offline Calibration [[Link](https://arxiv.org/pdf/2505.24357)] <br> *Xianglong Yan, Zhiteng Li, Tianao Zhang, Haotong Qin, Linghe Kong, Yulun Zhang, Xiaokang Yang* | Target cached KV tensors, head-group-wise for keys and layer-wise for values, budgeted-driven rank |![](https://img.shields.io/github/stars/XIANGLONGYAN/ReCalKV?style=social) <br> ![](https://img.shields.io/github/last-commit/XIANGLONGYAN/ReCalKV?color=green) <br> [ReCalKV](https://github.com/XIANGLONGYAN/ReCalKV) |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2025-blue)]() <br> Palu: KV-Cache Compression with Low-Rank Projection [[Link](https://openreview.net/pdf?id=LWMS4pk2vK)] <br> *Chi-Chih Chang, Wei-Cheng Lin, Chien-Yu Lin, Chong-Yan Chen, Yu-Fang Hu, Pei-Shuo Wang, Ning-Chi Huang, Luis Ceze, Mohamed S. Abdelfattah, Kai-Chiang Wu* | Target KV projection weights, head-group-wise, searched rank |![](https://img.shields.io/github/stars/shadowpa0327/Palu?style=social) <br> ![](https://img.shields.io/github/last-commit/shadowpa0327/Palu?color=green) <br> [Palu](https://github.com/shadowpa0327/Palu) |
| xKV: Cross-Layer SVD for KV-Cache Compression [[Link](https://arxiv.org/pdf/2503.18893)] <br> *Chi-Chih Chang, Chien-Yu Lin, Yash Akhauri, Wei-Cheng Lin, Kai-Chiang Wu, Luis Ceze, Mohamed S. Abdelfattah* | Target KV tensors, layer-group-wise, fixed rank |![](https://img.shields.io/github/stars/abdelfattah-lab/xKV?style=social) <br> ![](https://img.shields.io/github/last-commit/abdelfattah-lab/xKV?color=green) <br> [xKV](https://github.com/abdelfattah-lab/xKV) |
| Eigen Attention: Attention in Low-Rank Space for KV Cache Compression [[Link](https://aclanthology.org/2024.findings-emnlp.899.pdf)] <br> *Utkarsh Saxena, Gobinda Saha, Sakshi Choudhary, Kaushik Roy* | Target QKV attention subspace, layer-wise, budget-driven rank |![](https://img.shields.io/github/stars/UtkarshSaxena1/EigenAttn?style=social) <br> ![](https://img.shields.io/github/last-commit/UtkarshSaxena1/EigenAttn?color=green) <br> [EigenAttn](https://github.com/UtkarshSaxena1/EigenAttn) |
| LoRC: Low-Rank Compression for LLMs KV Cache with a Progressive Compression Strategy [[Link](https://arxiv.org/pdf/2410.03111)] <br> *Rongzhi Zhang, Kuang Wang, Liyuan Liu, Shuohang Wang, Hao Cheng, Chao Zhang, Yelong Shen* | Target KV projection weights, layer-wise, progressive rank | |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2025-blue)]() <br> Ada-KV: Optimizing KV Cache Eviction by Adaptive Budget Allocation for Efficient LLM Inference [[Link](https://arxiv.org/pdf/2407.11550)] <br> *Yuan Feng, Junlin Lv, Yukun Cao, Xike Xie, S. Kevin Zhou* | Eviction policy: plug-in; budget policy: adaptive (head-wise, attention sparsity) |![](https://img.shields.io/github/stars/FFY0/AdaKV?style=social) <br> ![](https://img.shields.io/github/last-commit/FFY0/AdaKV?color=green) <br> [AdaKV](https://github.com/FFY0/AdaKV) |
| [![Publish](https://img.shields.io/badge/Conference-EMNLP_2025_Findings-blue)]() <br> DynamicKV: Task-Aware Adaptive KV Cache Compression for Long Context LLMs [[Link](https://arxiv.org/pdf/2412.14838)] <br> *Xiabin Zhou, Wenbin Wang, Minyan Zeng, Jiaxian Guo, Xuebo Liu, Li Shen, Min Zhang, Liang Ding* | Eviction policy: recent + attention w.r.t. instruction tokens; budget policy: adaptive (layer-wise, task-aware) | |
| [![Publish](https://img.shields.io/badge/Conference-EMNLP_2025_Findings-blue)]() <br> EvolKV: Evolutionary KV Cache Compression for LLM Inference [[Link](https://aclanthology.org/2025.findings-emnlp.88.pdf)] <br> *Bohan Yu, Yekun Chai* | Eviction policy: plug-in; budget policy: adaptive (layer-wise, evolutionary search) | |
|  [![Publish](https://img.shields.io/badge/Conference-SOSP_2025-cyan)]() <br> DiffKV: Differentiated Memory Management for Large Language Models with Parallel KV Compaction [[Link](https://dl.acm.org/doi/pdf/10.1145/3731569.3764810)] <br> 
...
```
@inproceedings{jiang2026towards,
