...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-ACL_2025_Findings-blue)]() <br> KVPR: Efficient LLM inference with i/o-aware KV cache partial recomputation [[Link](https://aclanthology.org/2025.findings-acl.997.pdf)] <br> *Chaoyi Jiang, Lei Gao, Hossein Entezari Zarch, Murali Annavaram* | |[![stars](https://img.shields.io/github/stars/chaoyij/KVPR?style=social)](https://github.com/chaoyij/KVPR) <br> ![](https://img.shields.io/github/last-commit/chaoyij/KVPR?color=green) <br> [KVPR](https://github.com/chaoyij/KVPR)  |
| PRESERVE: Prefetching Model Weights and KV-Cache in Distributed LLM Serving [[Link](https://arxiv.org/pdf/2501.08192)] <br> *Ahmet Caner Yüzügüler, Jiawei Zhuang, Lukas Cavigelli* | Also belongs to memory hierarchy KV orchestration (spatial) ||
| [![Publish](https://img.shields.io/badge/Conference-MLSys_2025-cyan)]() <br> NEO: Saving GPU Memory Crisis with CPU Offloading for Online LLM Inference [[Link](https://openreview.net/pdf?id=umgy9tWBLA)] <br> *Xuanlin Jiang, Yang Zhou, Shiyi Cao, Ion Stoica, Minlan Yu* | Also belongs to HW-aware execution |[![stars](https://img.shields.io/github/stars/NEO-MLSys25/NEO?style=social)](https://github.com/NEO-MLSys25/NEO) <br> ![](https://img.shields.io/github/last-commit/NEO-MLSys25/NEO?color=green) <br> [NEO](https://github.com/NEO-MLSys25/NEO) |
| Accelerating LLM Inference Throughput via Asynchronous KV Cache Prefetching [[Link](https://arxiv.org/pdf/2504.06319)] <br> *Yanhao Dong, Yubo Miao, Weinan Li, Xiao Zheng, Chao Wang, Feng Lyu* | Also belongs to memory hierarchy KV orchestration (spatial) ||
| [![Publish](https://img.shields.io/badge/Conference-ATC_2024-cyan)]() <br> Cost-Efficient Large Language Model Serving for Multi-turn Conversations with CachedAttention [[Link](https://www.usenix.org/system/files/atc24-gao-bin-cost.pdf)] <br> *Bin Gao, Zhuomin He, Puru Sharma, Qingxuan Kang, Djordje Jevdjic, Junbo Deng, Xingkun Yang, Zhou Yu, Pengfei Zuo* | Also belongs to memory hierarchy KV orchestration (spatial) ||
| FastDecode: High-Throughput GPU-Efficient LLM Serving using Heterogeneous Pipelines [[Link](https://arxiv.org/pdf/2403.11421)] <br> *Jiaao He, Jidong Zhai* | Also belongs to HW-aware execution ||
| [![Publish](https://img.shields.io/badge/Conference-PACT_2024-cyan)]() <br> Improving Throughput-Oriented LLM Inference with CPU Computations [[Link](https://dl.acm.org/doi/pdf/10.1145/3656019.3676949)] <br> *Daon Park, Bernhard Egger* | Also belongs to HW-aware execution |[![GitLab](https://img.shields.io/badge/View%20on-GitLab-orange?logo=gitlab)](https://gitlab.csap.snu.ac.kr/research/heterogen) <br> [Heterogen](https://gitlab.csap.snu.ac.kr/research/heterogen)|
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-MLSys_2025-cyan)]() <br> NEO: Saving GPU Memory Crisis with CPU Offloading for Online LLM Inference [[Link](https://openreview.net/pdf?id=umgy9tWBLA)] <br> *Xuanlin Jiang, Yang Zhou, Shiyi Cao, Ion Stoica, Minlan Yu* | Also belongs to pipelining & overlapping |[![stars](https://img.shields.io/github/stars/NEO-MLSys25/NEO?style=social)](https://github.com/NEO-MLSys25/NEO) <br> ![](https://img.shields.io/github/last-commit/NEO-MLSys25/NEO?color=green) <br> [NEO](https://github.com/NEO-MLSys25/NEO) |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2025-blue)]() ![Award](https://img.shields.io/badge/Spotlight-gold?logo=star&logoColor=white) <br> MagicPIG: LSH Sampling for Efficient LLM Generation [[Link](https://openreview.net/pdf?id=ALzTQUgW8a)] <br> *Zhuoming Chen, Ranajoy Sadhukhan, Zihao Ye, Yang Zhou, Jianyu Zhang, Niklas Nolte, Yuandong Tian, Matthijs Douze, Leon Bottou, Zhihao Jia, Beidi Chen* |  |[![stars](https://img.shields.io/github/stars/Infini-AI-Lab/MagicPIG?style=social)](https://github.com/Infini-AI-Lab/MagicPIG) <br> ![](https://img.shields.io/github/last-commit/Infini-AI-Lab/MagicPIG?color=green) <br> [MagicPIG](https://github.com/Infini-AI-Lab/MagicPIG)|
| [![Publish](https://img.shields.io/badge/Conference-ASPLOS_2025-cyan)]() <br> PAPI: Exploiting Dynamic Parallelism in Large Language Model Decoding with a Processing-In-Memory-Enabled Computing System [[Link](https://dl.acm.org/doi/pdf/10.1145/3676641.3716009)] <br> *Yintao He, Haiyu Mao, Christina Giannoula, Mohammad Sadrosadati, Juan Gómez-Luna, Huawei Li, Xiaowei Li, Ying Wang, Onur Mutlu* |  | ASPLOS | |
| [![Publish](https://img.shields.io/badge/Conference-SYSTOR_2024-cyan)]() <br> TwinPilots: A New Computing Paradigm for GPU-CPU Parallel LLM Inference [[Link](https://dl.acm.org/doi/pdf/10.1145/3688351.3689164)] <br> *Chengye Yu, Tianyu Wang, Zili Shao, Linjie Zhu, Xu Zhou, Song JiangAuthors Info & Claims* | | |
| InstInfer: In-Storage Attention Offloading for Cost-Effective Long-Context LLM Inference [[Link](https://arxiv.org/pdf/2409.04992)] <br> *Xiurui Pan, Endian Li, Qiao Li, Shengwen Liang, Yizhou Shan, Ke Zhou, Yingwei Luo, Xiaolin Wang, Jie Zhang*| Also belongs to compute device KV orchestration (spatial) | |
| [![Publish](https://img.shields.io/badge/Conference-ASPLOS_2024-cyan)]() <br> AttAcc! unleashing the power of PIM for batched transformer-based generative model inference [[Link](https://dl.acm.org/doi/10.1145/3620665.3640422)] <br> *Jaehyun Park, Jaewan Choi, Kwanhee Kyung, Michael Jaemin Kim, Yongsuk Kwon, Nam Sung Kim, Jung Ho Ahn* | Also belongs to compute device KV orchestration (spatial) |[![stars](https://img.shields.io/github/stars/scale-snu/attacc_simulator?style=social)](https://github.com/scale-snu/attacc_simulator) <br> ![](https://img.shields.io/github/last-commit/scale-snu/attacc_simulator?color=green) <br> [AttAcc](https://github.com/scale-snu/attacc_simulator) |
| FastDecode: High-Throughput GPU-Efficient LLM Serving using Heterogeneous Pipelines [[Link](https://arxiv.org/pdf/2403.11421)] <br> *Jiaao He, Jidong Zhai* | Also belongs to pipelining & overlapping ||
| [![Publish](https://img.shields.io/badge/Conference-PACT_2024-cyan)]() <br> Improving Throughput-Oriented LLM Inference with CPU Computations [[Link](https://dl.acm.org/doi/pdf/10.1145/3656019.3676949)] <br> *Daon Park, Bernhard Egger* | Also belongs to pipelining & overlapping |[![GitLab](https://img.shields.io/badge/View%20on-GitLab-orange?logo=gitlab)](https://gitlab.csap.snu.ac.kr/research/heterogen) <br> [Heterogen](https://gitlab.csap.snu.ac.kr/research/heterogen)|
...
|Paper|Type|Code|
| -- | -- | -- |
| PRESERVE: Prefetching Model Weights and KV-Cache in Distributed LLM Serving [[Link](https://arxiv.org/pdf/2501.08192)] <br> *Ahmet Caner Yüzügüler, Jiawei Zhuang, Lukas Cavigelli* | Also belongs to pipelining & overlapping (temporal) ||
| Accelerating LLM Inference Throughput via Asynchronous KV Cache Prefetching <br> *Yanhao Dong, Yubo Miao, Weinan Li, Xiao Zheng, Chao Wang, Feng Lyu* [[Link](https://arxiv.org/pdf/2504.06319)] | Also belongs to pipelining & overlapping (temporal) ||
...
|Paper|Type|Code|
| -- | -- | -- |
| InstInfer: In-Storage Attention Offloading for Cost-Effective Long-Context LLM Inference [[Link](https://arxiv.org/pdf/2409.04992)] <br> *Xiurui Pan, Endian Li, Qiao Li, Shengwen Liang, Yizhou Shan, Ke Zhou, Yingwei Luo, Xiaolin Wang, Jie Zhang* | Also belongs to HW-aware execution (temporal) | |
| [![Publish](https://img.shields.io/badge/Conference-SIGCOMM_2024-cyan)]() <br> CacheGen: KV Cache Compression and Streaming for Fast Large Language Model Serving [[Link](https://dl.acm.org/doi/pdf/10.1145/3651890.3672274)]  <br> *Yuhan Liu, Hanchen Li, Yihua Cheng, Siddhant Ray, Yuyang Huang, Qizheng Zhang, Kuntai Du, Jiayi Yao, Shan Lu, Ganesh Ananthanarayanan, Michael Maire, Henry Hoffmann, Ari Holtzman, Junchen Jiang* | Also belongs to KV cache compression (structural) |[![stars](https://img.shields.io/github/stars/UChi-JCL/CacheGen?style=social)](https://github.com/UChi-JCL/CacheGen) <br> ![](https://img.shields.io/github/last-commit/UChi-JCL/CacheGen?color=green) <br> [CacheGen](https://github.com/UChi-JCL/CacheGen) |
| [![Publish](https://img.shields.io/badge/Conference-OSDI_2024-cyan)]() <br> DistServe: Disaggregating Prefill and Decoding for Goodput-optimized Large Language Model Serving [[Link](https://www.usenix.org/system/files/osdi24-zhong-yinmin.pdf)] <br> *Yinmin Zhong, Shengyu Liu, Junda Chen, Jianbo Hu, Yibo Zhu, Xuanzhe Liu, Xin Jin, Hao Zhang* | Also belongs to HW-aware execution (temporal) |[![stars](https://img.shields.io/github/stars/LLMServe/DistServe?style=social)](https://github.com/LLMServe/DistServe) <br> ![](https://img.shields.io/github/last-commit/LLMServe/DistServe?color=green) <br> [DistServe](https://github.com/LLMServe/DistServe) |
| Infinite-LLM: Efficient LLM Service for Long Context with DistAttention and Distributed KVCache [[Link](https://arxiv.org/pdf/2401.02669)] <br> *Bin Lin, Chen Zhang, Tao Peng, Hanyu Zhao, Wencong Xiao, Minmin Sun, Anmin Liu, Zhipeng Zhang, Lanbo Li, Xiafei Qiu, Shen Li, Zhigang Ji, Tao Xie, Yong Li, Wei Lin* | Also belongs to HW-aware execution (temporal) ||
| [![Publish](https://img.shields.io/badge/Conference-ISCA_2024-cyan)]() <br> Splitwise: Efficient generative LLM inference using phase splitting [[Link](https://arxiv.org/pdf/2311.18677)] <br> *Pratyush Patel, Esha Choukse, Chaojie Zhang, Aashaka Shah, Íñigo Goiri, Saeed Maleki, Ricardo Bianchini* | Also belongs to HW-aware execution (temporal) |[Splitwise](https://github.com/vllm-project/vllm/pull/2809) (integrated into vLLM) |
| [![Publish](https://img.shields.io/badge/Conference-ASPLOS_2024-cyan)]() <br> AttAcc! unleashing the power of PIM for batched transformer-based generative model inference [[Link](https://dl.acm.org/doi/10.1145/3620665.3640422)] <br> *Jaehyun Park, Jaewan Choi, Kwanhee Kyung, Michael Jaemin Kim, Yongsuk Kwon, Nam Sung Kim, Jung Ho Ahn* | Also belongs to HW-aware execution (temporal) |[![stars](https://img.shields.io/github/stars/scale-snu/attacc_simulator?style=social)](https://github.com/scale-snu/attacc_simulator) <br> ![](https://img.shields.io/github/last-commit/scale-snu/attacc_simulator?color=green) <br> [AttAcc](https://github.com/scale-snu/attacc_simulator) |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2023-blue)]() <br> Distributed Inference and Fine-tuning of Large Language Models Over The Internet [[Link](https://openreview.net/pdf?id=XmN7ZNbUAe)] <br> *Alexander Borzunov, Max Ryabinin, Artem Chumachenko, Dmitry Baranchuk, Tim Dettmers, Younes Belkada, Pavel Samygin, Colin Raffel*| Also belongs to memory hierarchy KV orchestration |[![stars](https://img.shields.io/github/stars/LLMServe/FastServe?style=social)](https://github.com/LLMServe/FastServe) <br> ![](https://img.shields.io/github/last-commit/LLMServe/FastServe?color=green) <br> [FastServe](https://github.com/LLMServe/FastServe) |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-ICML_2025-blue)]() ![Award](https://img.shields.io/badge/Spotlight-gold?logo=star&logoColor=white) <br> ShadowKV: KV Cache in Shadows for High-Throughput Long-Context LLM Inference [[Link](https://openreview.net/pdf?id=oa7MYAO6h6)] <br> *Hanshi Sun, Li-Wen Chang, Wenlei Bao, Size Zheng, Ningxin Zheng, Xin Liu, Harry Dong, Yuejie Chi, Beidi Chen* | Also belongs memory hierarchy KV orchestration (spatial) | ![](https://img.shields.io/github/stars/ByteDance-Seed/ShadowKV?style=social) <br> ![](https://img.shields.io/github/last-commit/ByteDance-Seed/ShadowKV?color=green) <br> [ShadowKV](https://github.com/ByteDance-Seed/ShadowKV) |
| FDC: Fast KV Dimensionality Compression for Efficient LLM Inference [[Link](https://arxiv.org/pdf/2408.04107)] <br> *Zeyu Zhang, Haiying Shen* | | |
| ReCalKV: Low-Rank KV Cache Compression via Head Reordering and Offline Calibration [[Link](https://arxiv.org/pdf/2505.24357)] <br> *Xianglong Yan, Zhiteng Li, Tianao Zhang, Haotong Qin, Linghe Kong, Yulun Zhang, Xiaokang Yang* |  |![](https://img.shields.io/github/stars/XIANGLONGYAN/ReCalKV?style=social) <br> ![](https://img.shields.io/github/last-commit/XIANGLONGYAN/ReCalKV?color=green) <br> [ReCalKV](https://github.com/XIANGLONGYAN/ReCalKV) |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2025-blue)]() <br> MatryoshkaKV: Adaptive KV Compression via Trainable Orthogonal Projection [[Link](https://openreview.net/pdf?id=BQwsRy1h3U)] <br> *Bokai Lin, Zihao Zeng, Zipeng Xiao, Siqi Kou, Tianqi Hou, Xiaofeng Gao, Hao Zhang, Zhijie Deng* |  |![](https://img.shields.io/github/stars/The-kamisato-Sii/MatryoshkaKV-cache?style=social) <br> ![](https://img.shields.io/github/last-commit/The-kamisato-Sii/MatryoshkaKV-cache?color=green) <br> [MatryoshkaKV-cache](https://github.com/The-kamisato-Sii/MatryoshkaKV-cache) |
| [![Publish](https://img.shields.io/badge/Conference-ICLR_2025-blue)]() <br> Palu: KV-Cache Compression with Low-Rank Projection [[Link](https://openreview.net/pdf?id=LWMS4pk2vK)] <br> *Chi-Chih Chang, Wei-Cheng Lin, Chien-Yu Lin, Chong-Yan Chen, Yu-Fang Hu, Pei-Shuo Wang, Ning-Chi Huang, Luis Ceze, Mohamed S. Abdelfattah, Kai-Chiang Wu* |  |![](https://img.shields.io/github/stars/shadowpa0327/Palu?style=social) <br> ![](https://img.shields.io/github/last-commit/shadowpa0327/Palu?color=green) <br> [Palu](https://github.com/shadowpa0327/Palu) |
| xKV: Cross-Layer SVD for KV-Cache Compression [[Link](https://arxiv.org/pdf/2503.18893)] <br> *Chi-Chih Chang, Chien-Yu Lin, Yash Akhauri, Wei-Cheng Lin, Kai-Chiang Wu, Luis Ceze, Mohamed S. Abdelfattah* |  |![](https://img.shields.io/github/stars/abdelfattah-lab/xKV?style=social) <br> ![](https://img.shields.io/github/last-commit/abdelfattah-lab/xKV?color=green) <br> [xKV](https://github.com/abdelfattah-lab/xKV) |
| LoRC: Low-Rank Compression for LLMs KV Cache with a Progressive Compression Strategy [[Link](https://arxiv.org/pdf/2410.03111)] <br> *Rongzhi Zhang, Kuang Wang, Liyuan Liu, Shuohang Wang, Hao Cheng, Chao Zhang, Yelong Shen* |  | |
| [![Publish](https://img.shields.io/badge/Conference-ICML_2024-blue)]() <br> Get More with LESS: Synthesizing Recurrence with KV Cache Compression for Efficient LLM Inference [[Link](https://openreview.net/pdf?id=uhHDhVKFMW)] <br> *Harry Dong, Xinyu Yang, Zhenyu Zhang, Zhangyang Wang, Yuejie Chi, Beidi Chen* |  |[![stars](https://img.shields.io/github/stars/hdong920/LESS?style=social)](https://github.com/hdong920/LESS) <br> ![](https://img.shields.io/github/last-commit/hdong920/LESS?color=green) <br> [LESS](https://github.com/hdong920/LESS) |
| Effectively Compress KV Heads for LLM [[Link](https://arxiv.org/pdf/2406.07056)] <br> *Hao Yu, Zelan Yang, Shen Li, Yong Li, Jianxin Wu* |  | |
...
| Model Tells You Where to Merge: Adaptive KV Cache Merging for LLMs on Long-Context Tasks [[Link](https://arxiv.org/pdf/2407.08454)] <br> *Zheng Wang, Boxiao Jin, Zhongzhi Yu, Minjia Zhang*| | |
| SubGen: Token Generation in Sublinear Time and Memory [[Link](https://arxiv.org/pdf/2402.06082)] <br> *Amir Zandieh, Insu Han, Vahab Mirrokni, Amin Karbasi* |  | |
...
|Paper|Type|Code|
| -- | -- | -- |
| [![Publish](https://img.shields.io/badge/Conference-MLSys_2025-cyan)]() ![Award](https://img.shields.io/badge/Outstanding%20Paper%20Award-gold?logo=star&logoColor=white) <br> FlashInfer: Efficient and Customizable Attention Engine for LLM Inference Serving [[Link](https://openreview.net/pdf?id=RXPofAsL8F)] <br> *Zihao Ye, Lequn Chen, Ruihang Lai, Wuwei Lin, Yineng Zhang, Stephanie Wang, Tianqi Chen, Baris Kasikci, Vinod Grover, Arvind Krishnamurthy, Luis Ceze* | Also belongs to KV-centric scheduling (temporal) | ![](https://img.shields.io/github/stars/flashinfer-ai/flashinfer?style=social) <br> ![](https://img.shields.io/github/last-commit/flashinfer-ai/flashinfer?color=green) <br> [FlashInfer](https://github.com/flashinfer-ai/flashinfer) 🌟 |
| Unifying KV Cache Compression for Large Language Models with LeanKV [[Link](https://arxiv.org/pdf/2412.03131v2)] <br> *Yanqi Zhang, Yuwei Hu, Runyuan Zhao, John C.S. Lui, Haibo Chen*| Also belongs to eviction | |
| [![Publish](https://img.shields.io/badge/Conference-ASPLOS_2025-cyan)]() <br> vAttention: Dynamic Memory Management for Serving LLMs without PagedAttention [[Link](https://dl.acm.org/doi/pdf/10.1145/3669940.3707256)] <br> *Ramya Prabhu, Ajay Nayak, Jayashree Mohan, Ramachandran Ramjee, Ashish Panwar*|  | ![](https://img.shields.io/github/stars/microsoft/vattention?style=social) <br> ![](https://img.shields.io/github/last-commit/microsoft/vattention?color=green) <br> [vAttention](https://github.com/microsoft/vattention) |
| MemServe: Context Caching for Disaggregated LLM Serving with Elastic Memory Pool [[Link](https://arxiv.org/pdf/2406.17565)] <br> *Cunchen Hu, Heyang Huang, Junhao Hu, Jiang Xu, Xusheng Chen, Tao Xie, Chenxi Wang, Sa Wang, Yungang Bao, Ninghui Sun, Yizhou Shan*|  |  |
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2024-blue)]() <br> SGLang: Efficient Execution of Structured Language Model Programs [[Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/724be4472168f31ba1c9ac630f15dec8-Paper-Conference.pdf)] <br> *Lianmin Zheng, Liangsheng Yin, Zhiqiang Xie, Chuyue Sun, Jeff Huang, Cody Hao Yu, Shiyi Cao, Christos Kozyrakis, Ion Stoica, Joseph E. Gonzalez, Clark Barrett, Ying Sheng* | Also belongs to KV-centric scheduling (temporal) |![](https://img.shields.io/github/stars/sgl-project/sglang?style=social) <br> ![](https://img.shields.io/github/last-commit/sgl-project/sglang?color=green) <br> [SGLang](https://github.com/sgl-project/sglang) 🌟 |
| FastSwitch: Optimizing Context Switching Efficiency in Fairness-aware Large Language Model Serving [[Link](https://arxiv.org/pdf/2411.18424)] <br> *Ao Shen, Zhiyao Li, Mingyu Gao* | Also belongs to memory hierarchy KV orchestration (spatial) || 
| [![Publish](https://img.shields.io/badge/Conference-ACL_2024-blue)]() <br> ChunkAttention: Efficient Self-Attention with Prefix-Aware KV Cache and Two-Phase Partition [[Link](https://aclanthology.org/2024.acl-long.623.pdf)] <br> *Lu Ye, Ze Tao, Yong Huang, Yang Li*|  | ![](https://img.shields.io/github/stars/microsoft/chunk-attention?style=social) <br> ![](https://img.shields.io/github/last-commit/microsoft/chunk-attention?color=green) <br> [Chunk Attention](https://github.com/microsoft/chunk-attention) |
| vTensor: Flexible Virtual Tensor Management for Efficient LLM Serving [[Link](https://arxiv.org/pdf/2407.15309)] <br> *Jiale Xu, Rui Zhang, Cong Guo, Weiming Hu, Zihan Liu, Feiyang Wu, Yu Feng, Shixuan Sun, Changxu Shao, Yuhong Guo, Junping Zhao, Ke Zhang, Minyi Guo, Jingwen Leng* |  |  |
| LazyLLM: Dynamic Token Pruning for Efficient Long Context LLM Inference [[Link](https://arxiv.org/pdf/2407.14057)] <br> *Qichen Fu, Minsik Cho, Thomas Merth, Sachin Mehta, Mohammad Rastegari, Mahyar Najibi* |  |  |
| [![Publish](https://img.shields.io/badge/Conference-MLSys_2024-cyan)]() <br> Prompt Cache: Modular Attention Reuse for Low-Latency Inference [[Link](https://proceedings.mlsys.org/paper_files/paper/2024/file/a66caa1703fe34705a4368c3014c1966-Paper-Conference.pdf)] <br> *In Gim, Guojun Chen, Seung-seob Lee, Nikhil Sarda, Anurag Khandelwal, Lin Zhong* |  | ![](https://img.shields.io/github/stars/yale-sys/prompt-cache?style=social) <br> ![](https://img.shields.io/github/last-commit/yale-sys/prompt-cache?color=green) <br> [Prompt Cache](https://github.com/yale-sys/prompt-cache) |
...
| [![Publish](https://img.shields.io/badge/Conference-NeurIPS_2024-blue)]() <br> SnapKV: LLM Knows What You are Looking for Before Generation [[Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/28ab418242603e0f7323e54185d19bde-Paper-Conference.pdf)] <br> *Yuhong Li, Yingbing Huang, Bowen Yang, Bharat Venkitesh, Acyr Locatelli, Hanchen Ye, Tianle Cai, Patrick Lewis, Deming Chen* | |![](https://img.shields.io/github/stars/FasterDecoding/SnapKV?style=social) <br> ![](https://img.shields.io/github/last-commit/FasterDecoding/SnapKV?color=green) <br> [SnapKV](https://github.com/FasterDecoding/SnapKV) |
